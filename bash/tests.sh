...
# Prompt the user for the first number (firstNumber)
read -p "Provide the first number (firstNumber): " firstNumber

# Prompt the user for the second number (secondNumber)
read -p "provide the second number (secondNumber): " secondNumber
...
[ -v USER ] && echo "The variable USER exists" || echo "The variable USER does not exist"
...
# Prompt the user for the first string (a)
read -p "Enter the first string (a): " a

# Prompt the user for the second string (b)
read -p "Enter the second string (b): " b
